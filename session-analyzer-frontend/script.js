...
const API_BASE_URL = "https://your-backend-url.vercel.app/api"; // Update this after backend deployment
...
async function checkServerHealth() {
  ...
  try {
    ...
    statusText.textContent = "Connection error - Check API URL in script.js";
...
async function submitQuery() {
  ...
  try {
    ...
    if (error.name === "AbortError") {
      ...
      showError(
        "Network error: Could not connect to API server. Please check if the backend is deployed."
      );
    }
